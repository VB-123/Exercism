...
def categorize_dish(dish_name, dish_ingredients):
    ...
    for category_name, category_set in FOOD_CATEGORIES.items():
...
def compile_ingredients(dishes):
    ...
    return ingredients_list.union(*dishes)
...
def singleton_ingredients(dishes, intersection):
    ...
    """
    singleton_ingredients_list = set()
    for dish in dishes:
        singleton_ingredients_list.update(dish - intersection)
    return singleton_ingredients_list